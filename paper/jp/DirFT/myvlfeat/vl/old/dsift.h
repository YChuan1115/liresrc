...
typedef struct VlDsiftFilter_
{
  ...
  int useDirTransform;     /**< Dirichlet-based transform */
...
VL_INLINE void vl_dsift_set_dirichlet_transform (VlDsiftFilter *self, vl_bool useDirTransform, float DirEpsilon) ;
/** @} */
...
VL_INLINE vl_bool         vl_dsift_get_dirichlet_transform     (VlDsiftFilter const *self) ;
VL_INLINE float           vl_dsift_get_dirichlet_epsilon     (VlDsiftFilter const *self) ;
...
/** ------------------------------------------------------------------
 ** @brief Set Dirichlet transform flag
 ** @param self DSIFT filter object.
 ** @param useDirTransform @c true if the DSIFT filter should use a flat window.
 ** @param DirEpsilon small fraction.
 **/

void
vl_dsift_set_dirichlet_transform (VlDsiftFilter* self,
                         vl_bool useDirTransform, float DirEpsilon)
{
  self->useDirTransform = useDirTransform ;
  self->DirEpsilon = DirEpsilon ;
  self->DirBias    = vl_log2_f( DirEpsilon );
}

int
vl_dsift_get_dirichlet_transform(VlDsiftFilter const * self)
{
  return self->useDirTransform ;
}

float
vl_dsift_get_dirichlet_epsilon(VlDsiftFilter const * self)
{
