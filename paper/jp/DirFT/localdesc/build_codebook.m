...
fprintf('K-means: %4d words\n', nword);
[words, priors] = mykmeans(X, nword);
save(fullfile(opath,sprintf('localdesc_visualwords%d_%d_%s.mat', nword, struct2hash(lparams), testtype)), 'words','priors','lparams');
